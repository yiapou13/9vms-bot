    ...
    execute(message, options) {
        ...
        channel.send({embed: {
            ...
            fields: [{
              ...
              {
                name: "Description",
                value: "Πάω λίγο να στείλω τον Obama στον λευκό οίκο και έρχομαι.\n♫ Μελισόους, μέλι, είναι σαν beat απ' τον Καμπίτση, θα σου το στρίψει, meldown, easy, έλα να στρίψεις το αρίρι, να σου το σκάσει και να το στρίψει.\n♫ Πίνω, πίνω, πίνω σάσι μήλο με κανέλα, μήλο με κανέλα, μήλο με κανέλα, με κανέλα.\nΈλα λίγο ρε.\nΚαμιά σφαίρα θα μπούμε;\nΈλα μπες κάνα λολάκι ρε.\nΔεν κόβεις ούτε με βαλέ μαλάκα.\nΜελισναουτσνερικά μιλάς;\nΕ, παίζει να έχεις grinder;\nΕ, τον Μανάκη τι τον έχεις;",
                inline: true
              },
              {
                name: "\u200B",
