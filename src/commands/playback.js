...
const fs = require('fs');
const track = 71 // number of ριο audio files
...
module.exports = {
    ...
    execute(message, options) {
        ...
        if ((atLeastOneWord.length == '1' && parseInt(atLeastOneWord[0]) <= (track - 1) && parseInt(atLeastOneWord[0]) >= 0) || parseInt(atLeastOneWord[0]) === 666 || parseInt(atLeastOneWord[0]) === 420 || parseInt(atLeastOneWord[0]) === 9000) {
            clip = atLeastOneWord;
        }
